...
export const searchEntities: Array<SearchItemResponse> = [
  {
...
export interface PmApiMetricEndpointResponse {
  context: number,
  metrics: Array<PmApiMetricEndpointMetricResponse>
};

export const detailEntities: Array<PmApiMetricEndpointResponse> = [
  {
    "context": 1173037301,
    "metrics": [
      {
